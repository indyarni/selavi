    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/services/**").hasRole("SECDE-APP-SELAVI-TEST-USER")
                .antMatchers(HttpMethod.PUT, "/services/**").hasRole("SECDE-APP-SELAVI-TEST-USER")
                .antMatchers(HttpMethod.DELETE, "/services/**").hasRole("SECDE-APP-SELAVI-TEST-USER")
